...
当前稳定下载版为 v1.6.0；源码已进入 v1.8.0-alpha.2 开发阶段，重点收敛飞书表结构、标签库闭环和后续大功能用户体验测试反馈。
...
如果要体验当前 v1.8 开发线，可以使用 alpha 测试包：

- [H5游戏评测助手-v1.8.0-alpha.2.zip](downloads/H5游戏评测助手-v1.8.0-alpha.2.zip)
